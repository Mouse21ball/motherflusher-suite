            ...
            {modes.map((mode) => (
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="text-white/25 group-hover:text-white/60 transition-colors text-lg shrink-0 self-center">
                    ›
                  </div>
                </div>
              </button>
