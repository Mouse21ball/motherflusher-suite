  ...
  return (
    <div className="w-full px-2 pt-2">
      <div className="max-w-md mx-auto rounded-xl bg-purple-500/[0.08] border border-purple-500/25 px-3.5 py-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex flex-col gap-0.5 min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-[12px] font-mono uppercase tracking-[0.18em] text-purple-400 font-bold leading-none">
                Spectating
              </span>
              {spectatorCount != null && spectatorCount > 0 && (
                <span className="flex items-center gap-0.5 text-[12px] text-purple-400/60 font-mono">
                  <Users className="w-2.5 h-2.5" />
                  {spectatorCount}
                </span>
              )}
            </div>
            <span className="text-[12px] text-white/60 leading-none truncate">
        ...
        <button
          onClick={() => navigate('/')}
          className="shrink-0 text-[12px] font-mono uppercase tracking-widest px-2.5 py-1.5 rounded-lg border border-purple-500/20 text-purple-400/60 hover:text-purple-400 hover:border-purple-500/35 bg-purple-500/[0.05] hover:bg-purple-500/[0.1] transition-all duration-200 touch-manipulation"
