...
export const MODE_INTROS: Record<string, Omit<ModeIntroProps, "modeId">> = {
  swing: {
    ...
    objective: "Declare High for the best poker hand, Low for the best suit total, or Swing to try winning both. A 15-card community board reveals in stages — bet after each.",
    steps: [
  ...
  dead7: {
    title: "Dead 7",
    objective: "Build a 4-card hand where every card qualifies High (8 or above) or Low (6 or below). Any 7 in your hand kills it — no exceptions.",
    steps: [
