-- Generated from shared/schema.ts with drizzle-kit generate.
-- This file establishes migration history only; it has not been applied.
-- Do not run this baseline against an already initialized production database.
...
CREATE TABLE "player_profiles" (
	...
	"subscription_last_stripes_grant_at" timestamp,
